...
protocol TweetViewCellDelegate {
    func onReply(tweetCell: TweetViewCell)
    func onRetweet(tweetCell: TweetViewCell)
    func onFavorite(tweetCell: TweetViewCell)
    func onProfileImageTap(tweetCell: TweetViewCell)
}

class TweetViewCell: UITableViewCell {
    
    // Load the delegate back
    weak var delegate: TweetsView?
